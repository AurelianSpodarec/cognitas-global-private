$(document).on('ready', function () {
    ...
    if( $('.case-study-list__list').length ) {
      ...
      function checkNextCaseStudyPage(perPage, pageNumber, category, post_type, tags, month, year, trigger) {
        var data = {};
  
        sendData = {
          action: 'case_study_ajax_handler',
      ...
      function loadResults() {
        ...
        $.ajax({
          ...
          success: function (data, textStatus, jqXHR) {
            ...
            checkNextCaseStudyPage(perPage, nextPageNumber, category, post_type, tags, month, year, $loadMoreEntriesContainer);
