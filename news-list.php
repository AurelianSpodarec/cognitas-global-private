<?php 
    ...
    // get full list of news categories
	$news_categories = new WP_Term_Query([
		'taxonomy' => [ 'category' ],
	]);
	...
	$hide_button = $newsItems->max_num_pages <= 1 ? 'style="display: none;"' : null;
	// end of news logic
?>
			...
			<div class="main-container-1<?php if (is_front_page()) { echo ' home'; } ?>">
				...
				<div class="main-components">
                    <section class="news-list">
                        <div class="news-list__list js-news-container js-entries-container"
                            data-post-type="<?php echo $post_type; ?>"
                            data-per-page="<?php echo esc_attr($posts_per_page); ?>"
                            data-page-num="1"
                            data-total-pages="<?php echo esc_attr($newsItems->max_num_pages); ?>"
                            data-month="Month"
                            data-year="Year"
                            data-category="default"
                            >
                            <?php while ($newsItems->have_posts()) : $newsItems->the_post(); ?>
                                <?php get_template_part('template-parts/partials/news-item'); ?>
                            <?php endwhile;
                            wp_reset_postdata(); ?>
                        </div>
